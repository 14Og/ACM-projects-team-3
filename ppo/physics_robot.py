...
class Robot_Dynamic_3DOF:
    def __init__(self, masses, lengthes, cfg=RobotConfig()):
        self.m = masses
        self.l = lengthes
        self.cfg = cfg
    ...
    def coriolis_times_velocity(self, q, dq):
        """Return the vector C(q, dq) @ dq used by the manipulator dynamics."""
        return coriolis_vector(q, dq, self.m, self.l, self.lc)
